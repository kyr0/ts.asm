...
export const cr0 = cr(0)
export const cr1 = cr(1)
export const cr2 = cr(2)
export const cr3 = cr(3)
export const cr4 = cr(4)
export const cr5 = cr(5)
export const cr6 = cr(6)
export const cr7 = cr(7)
export const cr8 = cr(8)

export const dr0 = dr(0)
export const dr1 = dr(1)
export const dr2 = dr(2)
export const dr3 = dr(3)
export const dr4 = dr(4)
export const dr5 = dr(5)
export const dr6 = dr(6)
export const dr7 = dr(7)
export const dr8 = dr(8)
