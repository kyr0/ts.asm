...
describe('Binary Arithmetic', function () {
  describe('adcx', function () {
    it('adcx rcx, rbx', function () {
      // 66 48 0f 38 f6 cb    	adcx   %rbx,%rcx
      const _ = X64()
      _._('adcx', [rcx, rbx])
      const bin = _.compile([])
    ...
    it('adcx rax, rax', function () {
      // 66 48 0f 38 f6 c0    	adcx   %rax,%rax
      const _ = X64()
      _._('adcx', [rax, rax])
      const bin = _.compile([])
  ...
  describe('add', function () {
    ...
    it('add rcx, [rsp + rbp * 4 + 0x11]', function () {
      // 48 03 4c ac 11       	add    0x11(%rsp,%rbp,4),%rcx
      const _ = X64()
    ...
    it('add rcx, [rsp + rbp * 4 + -0x11223344]', function () {
      // 48 03 8c ac bc cc dd ee 	add    -0x11223344(%rsp,%rbp,4),%rcx
      const _ = X64()
    ...
    it('add [rsp + rbp * 4 + -0x11223344], rax', function () {
      // 48 01 84 ac bc cc dd ee 	add    %rax,-0x11223344(%rsp,%rbp,4)
      const _ = X64()
    ...
    it('add rbx, [1]', function () {
      // 48 03 1c 25 01 00 00 00 	add    0x1,%rbx
      const _ = X64()
    ...
    it('add [1], rbx', function () {
      // 48 01 1c 25 01 00 00 00 	add    %rbx,0x1
      const _ = X64()
    ...
    it('add rax, -0x11223344', function () {
      // 48 05 bc cc dd ee    	add $-0x11223344, %rax
      const _ = X64()
    ...
    it('add ebx, 0x1122', function () {
      // 81 c3 22 11 00 00    	add    $0x1122,%ebx
      const _ = X64()
      _._('add', [ebx, 0x1122])
      const bin = _.compile([])
  ...
  describe('adc', function () {
    it('adc [rbx + rcx * 4 + 0x11], rax', function () {
      // 48 11 44 8b 11       	adc    %rax,0x11(%rbx,%rcx,4)
      const _ = X64()
  ...
  describe('cmp', function () {
    ...
    it('cmp eax, 0x11223344', function () {
      // 3d 44 33 22 11       	cmp    $0x11223344,%eax
      const _ = X64()
    ...
    it('cmp rax, 0x11223344', function () {
      // 48 3d 44 33 22 11    	cmp    $0x11223344,%rax
      const _ = X64()
    ...
    it('cmp ebx, 0x11223344', function () {
      // 81 fb 44 33 22 11    	cmp    $0x11223344,%ebx
      const _ = X64()
    ...
    it('cmp rbx, 0x11223344', function () {
      // 48 81 fb 44 33 22 11 	cmp    $0x11223344,%rbx
      const _ = X64()
