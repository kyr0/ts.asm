...
describe('X64', function () {
  describe('lea', function () {
    ...
    it('lea rax, [rip]', function () {
      // 400662:	48 8d 05 00 00 00 00 	lea    0x0(%rip),%rax        # 400669 <lea+0x12>
      const _ = X64()
    ...
    it('lea rax, [rsp]', function () {
      // 40066c:	48 8d 04 24          	lea    (%rsp),%rax
      const _ = X64()
      _._('lea', [rax, rsp.ref()])
      const bin = compile(_)
    ...
    it('lea rax, [rbp]', function () {
      // 400670:	48 8d 45 00          	lea    0x0(%rbp),%rax
      const _ = X64()
      _._('lea', [rax, rbp.ref()])
      const bin = compile(_)
    ...
    it('lea r8, [rip + 0x11]', function () {
      // 400674:	4c 8d 05 11 00 00 00 	lea    0x11(%rip),%r8        # 40068c <lea+0x35>
      const _ = X64()
    ...
    it('lea r9, [rip + 0x11223344]', function () {
      // 40067b:	4c 8d 0d 44 33 22 11 	lea    0x11223344(%rip),%r9
      const _ = X64()
    ...
    it('lea r9, [rbx + rcx + 0x11]', function () {
      // 400682:	4c 8d 4c 0b 11       	lea    0x11(%rbx,%rcx,1),%r9
      const _ = X64()
    ...
    it('lea r9, [0x43]', function () {
      // 400687:	4c 8d 0c 25 43 00 00 00 	lea    0x43,%r9
      const _ = X64()
