...
describe('X64', () => {
  describe('cpuid', () => {
    it('compiles correctly', () => {
      ...
      expect(asm.compile([])).toEqual([
        0x53, 0x51, 0x52, 0x89, 0xf8, 0x89, 0xf1, 0xf, 0xa2, 0x89, 0x5, 0x19, 0x0, 0x0, 0x0, 0x89, 0x1d, 0x17, 0x0, 0x0,
        0x0, 0x89, 0x15, 0x15, 0x0, 0x0, 0x0, 0x89, 0xd, 0x13, 0x0, 0x0, 0x0, 0x5a, 0x59, 0x5b, 0xc3, 0xf, 0x1f, 0x0,
