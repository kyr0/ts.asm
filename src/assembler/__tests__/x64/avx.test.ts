...
describe('AVX', function () {
  describe('addps', function () {
    ...
    it('vaddps xmm3, xmm2, xmm1', function () {
      // c5 e8 58 d9          	vaddps %xmm1,%xmm2,%xmm3
      const _ = X64()
    ...
    it('vaddps xmm2, xmm1, [rax]', function () {
      // c5 f0 58 10          	vaddps (%rax),%xmm1,%xmm2
      const _ = X64()
    ...
    it('vaddps ymm12, ymm11, ymm10', function () {
      // c4 41 24 58 e2       	vaddps %ymm10,%ymm11,%ymm12
      const _ = X64()
    ...
    it('vaddps zmm20, zmm20, zmm20', function () {
      // 62 a1 5c 40 58 e4    	vaddps %zmm20,%zmm20,%zmm20
      const _ = X64()
    ...
    it('vaddps zmm22, zmm21, zmm20', function () {
      // 62 a1 54 40 58 f4    	vaddps %zmm20,%zmm21,%zmm22
      const _ = X64()
  ...
  describe('divsd', function () {
    ...
    it('vdivsd xmm1, xmm2, xmm3', function () {
      // c5 eb 5e cb          	vdivsd %xmm3,%xmm2,%xmm1
      const _ = X64()
    ...
    it('vdivsd xmm13 {k7}, xmm14, xmm15', function () {
      // 62 51 8f 0f 5e ef    	vdivsd %xmm15,%xmm14,%xmm13{%k7}
      const _ = X64()
